...
public class WobbleBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (current_state == WobbleBlue.States.TURN_RIGHT1) {
        ...
        while (current_state == WobbleBlue.States.DRIVE_OUT2) {
            robot.setDriveMotors(0.4, 0.4, 0.4, 0.4); //drive forwards
        ...
        while (current_state == WobbleBlue.States.DRIVE_BACK1) {
            robot.setDriveMotors(-0.4, -0.4, -0.4, -0.4); //drive forwards
        ...
        while (current_state == WobbleBlue.States.TURN_RIGHT2) {
            robot.setDriveMotors(0.4, -0.4, 0.4, -0.4); //turn right
            if (robot.DriveFrontLeft.getCurrentPosition() > robot.inchesToEncoderCounts(19.21)) {
                robot.stopAllMotors();
        ...
        while (current_state == WobbleBlue.States.DRIVE_OUT3) {
            robot.setDriveMotors(0.4, 0.4, 0.4, 0.4); //drive forwards
        ...
        while (current_state == WobbleBlue.States.TURN_LEFT1) {
        ...
        while (current_state == WobbleBlue.States.DRIVE_OUT4) {
            robot.setDriveMotors(0.4, 0.4, 0.4, 0.4); //drive forwards
            if (robot.DriveFrontLeft.getCurrentPosition() > robot.inchesToEncoderCounts(45.0)) {
                robot.stopAllMotors();
        ...
        while (current_state == WobbleBlue.States.TURN_LEFT2) {
            robot.setDriveMotors(-0.4, 0.4, -0.4, 0.4); //turn left
            if (robot.DriveFrontLeft.getCurrentPosition() > robot.inchesToEncoderCounts(19.21)) {
                robot.stopAllMotors();
        ...
        while (current_state == WobbleBlue.States.DRIVE_OUT5) {
            robot.setDriveMotors(0.4, 0.4, 0.4, 0.4); //drive forwards
            if (robot.DriveFrontLeft.getCurrentPosition() > robot.inchesToEncoderCounts(33.0)) {
                robot.stopAllMotors();
        ...
        while (current_state == WobbleBlue.States.DRIVE_BACK2) {
            robot.setDriveMotors(-0.4, -0.4, -0.4, -0.4); //drive forwards
